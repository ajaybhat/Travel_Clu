...
public class BookTrip
    ...
    private void bookATrip() {
        String bookerName = httpServletRequest.getParameter("name");
        ...
        String returnDate = httpServletRequest.getParameter("return_date");
        int passengers = Integer.parseInt(httpServletRequest.getParameter("passengers"));
